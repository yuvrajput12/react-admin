...
import {Carts,Chats,Notification,UserProfile} from '.'
...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex'>
      <NavButton title="Cart" customFunc={()=> handleClick('cart')} color={currentColor} dotColor="#03c9D7" icon={<FiShoppingCart/>}/>
